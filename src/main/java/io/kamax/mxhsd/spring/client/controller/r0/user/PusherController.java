...
public class PusherController extends JsonController {

    private final Logger logger = LoggerFactory.getLogger(PusherController.class);
    ...
    public String getPushers(HttpServletRequest req) {
        ...
        return toJson(logger, GsonUtil.makeObj("pushers", new JsonArray()));
    }
